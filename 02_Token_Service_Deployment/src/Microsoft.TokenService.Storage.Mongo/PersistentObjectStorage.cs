...
{
    internal class PersistentObjectStorage<TEntity, TIdentifier> : IRepository<TEntity, TIdentifier> where TEntity : class, IEntityModel<TIdentifier>
    {
        private readonly IMongoDatabase _database;

        public PersistentObjectStorage(IMongoClient client, string DatabaseName)
        {
