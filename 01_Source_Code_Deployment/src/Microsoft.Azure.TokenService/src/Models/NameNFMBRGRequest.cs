...
namespace Microsoft.Azure.TokenService.Models
{
    ...
    /// <summary>
    /// Request for the name operation
    /// </summary>
    public partial class NameNFMBRGRequest
    {
        /// <summary>
        /// Initializes a new instance of the NameNFMBRGRequest class.
        /// </summary>
        public NameNFMBRGRequest()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the NameNFMBRGRequest class.
        /// </summary>
        public NameNFMBRGRequest(string callerGroupName = default(string), string callerAccountName = default(string), string requestId = default(string), object functionParams = default(object))
        {
