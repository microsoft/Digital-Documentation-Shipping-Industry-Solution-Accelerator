...
namespace Microsoft.Azure.TokenService.Models
{
    ...
    /// <summary>
    /// Request for the symbol operation
    /// </summary>
    public partial class SymbolNFMBRGRequest
    {
        /// <summary>
        /// Initializes a new instance of the SymbolNFMBRGRequest class.
        /// </summary>
        public SymbolNFMBRGRequest()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the SymbolNFMBRGRequest class.
        /// </summary>
        public SymbolNFMBRGRequest(string callerGroupName = default(string), string callerAccountName = default(string), string requestId = default(string), object functionParams = default(object))
        {
